...
class ControladorProfessor(ControladorAbstrato):
    ...
    def abre_tela(self):
        lista_opcoes = {1: self.incluir_professor, 2: self.alterar_professor, 3: self.excluir_professor, 4: self.lista_professores, 5: self.busca_professor_por_email, 0: self.retornar}
        continua = True
        while continua:
