...
class ControladorSistema(ControladorAbstrato):
    ...
    def __init__(self):
        self.__sistema = Sistema(self)
        self.__controlador_aluno = ControladorAluno(self)
        self.__controlador_professor = ControladorProfessor(self)
        self.__controlador_funcionario = ControladorFuncionario(self)
        self.__controlador_financas = ControladorFinancas(self.__controlador_aluno, self.__controlador_professor, self.__controlador_funcionario)
